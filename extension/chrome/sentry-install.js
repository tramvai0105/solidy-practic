...
},{"@sentry/utils":74}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SENTRY_STATE = exports.ERROR_URL_ALLOWLIST = void 0;
exports.beforeBreadcrumb = beforeBreadcrumb;
exports.default = setupSentry;
exports.removeUrlsFromBreadCrumb = removeUrlsFromBreadCrumb;
...
/* eslint-disable prefer-destructuring */ // Destructuring breaks the inlining of the environment variables
const METAMASK_DEBUG = true;
const METAMASK_ENVIRONMENT = "development";
const SENTRY_DSN_DEV = null || 'https://f59f3dd640d2429d9d0e2445a87ea8e1@sentry.io/273496';
...
exports.ERROR_URL_ALLOWLIST = ERROR_URL_ALLOWLIST;
const SENTRY_STATE = {
  gas: true,
  history: true,
  metamask: {
...
function setupSentry({
  ...
  const environment = METAMASK_BUILD_TYPE === 'main' ? METAMASK_ENVIRONMENT : `${METAMASK_ENVIRONMENT}-${METAMASK_BUILD_TYPE}`;
  let sentryTarget;
 ...
 */
function beforeBreadcrumb(getState) {
  return breadcrumb => {
    if (getState) {
 ...
 */
function removeUrlsFromBreadCrumb(breadcrumb) {
  var _breadcrumb$data, _breadcrumb$data2, _breadcrumb$data3;
  if (breadcrumb !== null && breadcrumb !== void 0 && (_breadcrumb$data = breadcrumb.data) !== null && _breadcrumb$data !== void 0 && _breadcrumb$data.url) {
    breadcrumb.data.url = hideUrlIfNotInternal(breadcrumb.data.url);
  }
  if (breadcrumb !== null && breadcrumb !== void 0 && (_breadcrumb$data2 = breadcrumb.data) !== null && _breadcrumb$data2 !== void 0 && _breadcrumb$data2.to) {
    breadcrumb.data.to = hideUrlIfNotInternal(breadcrumb.data.to);
  }
  if (breadcrumb !== null && breadcrumb !== void 0 && (_breadcrumb$data3 = breadcrumb.data) !== null && _breadcrumb$data3 !== void 0 && _breadcrumb$data3.from) {
 ...
 */
function rewriteReport(report, getState) {
  try {
  ...
  rewriteErrorMessages(report, errorMessage => {
    ...
    urlsInMessage.forEach(url => {
      try {
        ...
        if (!Object.values(ERROR_URL_ALLOWLIST).some(allowedHostname => hostname === allowedHostname || hostname.endsWith(`.${allowedHostname}`))) {
...
function simplifyErrorMessages(report) {
  rewriteErrorMessages(report, errorMessage => {
    ...
    let simplifiedErrorMessage = (0, _extractEthjsErrorMessage.default)(errorMessage);
...
function rewriteReportUrls(report) {
  var _report$request;
  if ((_report$request = report.request) !== null && _report$request !== void 0 && _report$request.url) {
    // update request url
...
function toMetamaskUrl(origUrl) {
  ...
  if (!((_globalThis$location = globalThis.location) !== null && _globalThis$location !== void 0 && _globalThis$location.origin)) {
    return origUrl;
  }
  const filePath = origUrl === null || origUrl === void 0 ? void 0 : origUrl.split(globalThis.location.origin)[1];
  if (!filePath) {
    return origUrl;
  }
...
},{"./extractEthjsErrorMessage":1,"./sentry-filter-events":2,"@sentry/browser":10,"@sentry/integrations":53}],4:[function(require,module,exports){
...
},{"./eventbuilder":7,"./transports":23,"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],6:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var utils_1 = require("@sentry/utils");
...
},{"./backend":5,"./helpers":9,"./integrations":14,"@sentry/core":31,"@sentry/utils":74,"tslib":27}],7:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var types_1 = require("@sentry/types");
var utils_1 = require("@sentry/utils");
...
},{"./parsers":18,"./tracekit":20,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],8:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = require("@sentry/types");
...
},{"./client":6,"./eventbuilder":7,"./helpers":9,"./sdk":19,"./version":26,"@sentry/core":31,"@sentry/types":63}],9:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var utils_1 = require("@sentry/utils");
...
},{"@sentry/core":31,"@sentry/utils":74,"tslib":27}],10:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"./exports":8,"./integrations":14,"./transports":23,"@sentry/core":31,"@sentry/utils":74,"tslib":27}],11:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],12:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("@sentry/utils");
...
},{"@sentry/utils":74}],13:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
/* eslint-disable @typescript-eslint/no-unsafe-member-access */
var core_1 = require("@sentry/core");
...
},{"../eventbuilder":7,"../helpers":9,"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],14:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../parsers":18,"../tracekit":20,"@sentry/core":31,"@sentry/utils":74,"tslib":27}],16:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
var helpers_1 = require("../helpers");
...
},{"../helpers":9,"@sentry/utils":74,"tslib":27}],17:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var utils_1 = require("@sentry/utils");
...
},{"@sentry/core":31,"@sentry/utils":74,"tslib":27}],18:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("@sentry/utils");
var tracekit_1 = require("./tracekit");
...
},{"./tracekit":20,"@sentry/utils":74}],19:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var utils_1 = require("@sentry/utils");
...
},{"./client":6,"./helpers":9,"./integrations":14,"@sentry/core":31,"@sentry/utils":74,"tslib":27}],20:[function(require,module,exports){
/**
...
},{"tslib":27}],21:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var types_1 = require("@sentry/types");
...
},{"./utils":24,"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],22:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var types_1 = require("@sentry/types");
...
},{"./base":21,"./utils":24,"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],23:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var base_1 = require("./base");
...
},{"@sentry/utils":74}],25:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var core_1 = require("@sentry/core");
var types_1 = require("@sentry/types");
...
},{"./base":21,"@sentry/core":31,"@sentry/types":63,"@sentry/utils":74,"tslib":27}],26:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@sentry/utils":74}],29:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("@sentry/utils");
...
},{"./transports/noop":38,"@sentry/utils":74}],30:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
/* eslint-disable max-lines */
...
},{"./integration":32,"@sentry/hub":42,"@sentry/types":63,"@sentry/utils":74,"tslib":40}],31:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./api":28,"./basebackend":29,"./baseclient":30,"./integrations":35,"./request":36,"./sdk":37,"./transports/noop":38,"./version":39,"@sentry/hub":42,"@sentry/minimal":61}],32:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var hub_1 = require("@sentry/hub");
var utils_1 = require("@sentry/utils");
...
},{"@sentry/hub":42,"@sentry/utils":74,"tslib":40}],33:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@sentry/hub":42,"@sentry/utils":74,"tslib":40}],35:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./functiontostring":33,"./inboundfilters":34}],36:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"tslib":40}],37:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var hub_1 = require("@sentry/hub");
var utils_1 = require("@sentry/utils");
/**
...
},{"@sentry/hub":42,"@sentry/utils":74}],38:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = require("@sentry/types");
var utils_1 = require("@sentry/utils");
/** Noop transport */
...
},{"@sentry/types":63,"@sentry/utils":74}],39:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./scope":43,"./session":44,"@sentry/types":63,"@sentry/utils":74,"tslib":46}],42:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var scope_1 = require("./scope");
...
},{"@sentry/utils":74,"tslib":46}],44:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = require("@sentry/types");
var utils_1 = require("@sentry/utils");
/**
...
},{"@sentry/types":63,"@sentry/utils":74}],45:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = require("@sentry/types");
var utils_1 = require("@sentry/utils");
var hub_1 = require("./hub");
...
},{"./hub":41,"@sentry/types":63,"@sentry/utils":74}],46:[function(require,module,exports){
(function (global){(function (){
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
},{"@sentry/utils":74,"tslib":60}],48:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = require("@sentry/types");
var utils_1 = require("@sentry/utils");
var global = utils_1.getGlobalObject();
...
},{"@sentry/types":63,"@sentry/utils":74}],49:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
/** JSDoc */
...
},{"@sentry/utils":74,"tslib":60}],50:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"@sentry/utils":74,"dup":12}],51:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("@sentry/utils");
/** JSDoc */
...
},{"@sentry/utils":74}],52:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
/** Patch toString calls to return proper name for wrapped functions */
...
},{"@sentry/utils":74,"tslib":60}],53:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./angular":47,"./captureconsole":48,"./debug":49,"./dedupe":50,"./ember":51,"./extraerrordata":52,"./offline":54,"./reportingobserver":55,"./rewriteframes":56,"./sessiontiming":57,"./transaction":58,"./vue":59}],54:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
...
},{"@sentry/utils":74,"localforage":91,"tslib":60}],55:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
/** JSDoc */
...
},{"@sentry/utils":74,"tslib":60}],56:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var utils_1 = require("@sentry/utils");
...
},{"@sentry/utils":74,"tslib":60}],57:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"tslib":60}],58:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@sentry/utils":74,"tslib":60}],60:[function(require,module,exports){
(function (global){(function (){
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
},{"@sentry/hub":42,"tslib":62}],62:[function(require,module,exports){
(function (global){(function (){
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
},{"./loglevel":64,"./session":65,"./severity":66,"./status":67,"./transaction":68,"./transport":69}],64:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./is":76}],72:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"./error":73,"tslib":90}],73:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"./polyfill":83,"tslib":90}],74:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"./async":70,"./browser":71,"./dsn":72,"./error":73,"./instrument":75,"./is":76,"./logger":77,"./memo":78,"./misc":79,"./node":80,"./object":81,"./path":82,"./promisebuffer":84,"./stacktrace":85,"./string":86,"./supports":87,"./syncpromise":88,"./time":89,"tslib":90}],75:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
var is_1 = require("./is");
...
},{"./is":76,"./logger":77,"./misc":79,"./object":81,"./stacktrace":85,"./supports":87,"tslib":90}],76:[function(require,module,exports){
...
},{"./misc":79}],78:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
/* eslint-disable @typescript-eslint/no-unsafe-member-access */
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable @typescript-eslint/explicit-module-boundary-types */
...
},{"./node":80,"./string":86}],80:[function(require,module,exports){
...
},{"_process":92}],81:[function(require,module,exports){
(function (global){(function (){
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require("tslib");
...
},{"./browser":71,"./is":76,"./memo":78,"./stacktrace":85,"./string":86,"tslib":90}],82:[function(require,module,exports){
...
},{"./error":73,"./syncpromise":88}],85:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./is":76}],87:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var logger_1 = require("./logger");
var misc_1 = require("./misc");
/**
...
},{"./logger":77,"./misc":79}],88:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./is":76}],89:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var misc_1 = require("./misc");
var node_1 = require("./node");
/**
...
},{"./misc":79,"./node":80}],90:[function(require,module,exports){
(function (global){(function (){
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
